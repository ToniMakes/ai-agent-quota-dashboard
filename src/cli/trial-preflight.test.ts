...
function codexStatus(
  ...
  return {
    snapshotPath: "C:\\Users\\testuser\\.ai-agent-quota-dashboard\\codex\\codex-quota-snapshot.json",
...
function claudeStatus(
  ...
  return {
    ...
    claudeCliExampleProjectOpenCommand:
      "Set-Location -LiteralPath 'C:\\Users\\testuser\\Desktop\\vibecoding\\AI Agent Quota Dashboard'\nclaude",
    claudeCliExampleProjectPath:
      "C:\\Users\\testuser\\Desktop\\vibecoding\\AI Agent Quota Dashboard",
    ...
    claudeCliPath: "C:\\Users\\testuser\\AppData\\Local\\Programs\\Claude\\claude.exe",
    ...
    shimPath: "C:\\Users\\testuser\\.ai-agent-quota-dashboard\\claude\\statusline.cjs",
    shimExists: overrides.readiness !== "needs_setup",
    latestPath: "C:\\Users\\testuser\\.ai-agent-quota-dashboard\\claude\\latest.json",
    ...
    historyPath: "C:\\Users\\testuser\\.ai-agent-quota-dashboard\\claude\\history.jsonl",
