...
- `dashboard-demo.png`: main dashboard with quota cards and reset summaries
- `doctor-demo.png`: Doctor and refresh history view
- `settings-demo.png`: first-run real-data setup flow
